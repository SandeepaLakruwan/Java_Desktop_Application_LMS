...
public class SignIn extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/logo64.png"))); // NOI18N
        jLabel4.setText(" Eduhub Institute");
        ...
        if(email.isEmpty()){
            ...
            try {
                ...
                if(resultset.next()){
                    ...
                    adminMap.put("adminName", resultset.getString("name"));
                    adminMap.put("adminType", resultset.getString("admin_type_id"));
